...
export const getDay = async (
  ...
  const link =
    'https://sk_live_qREL4HZOG5zkfZ0aBUBrJXaL:@api.octopus.energy/v1/electricity-meter-points/1012970871627/meters/13K0140729/consumption/';
